...
import { Slider, Caption, Slide, SideNav, SideNavItem, Row, Col, Card, CardTitle, Icon, Button } from "react-materialize";
  ...
  return (
    <div>
      <SideNav
        ...
        trigger={<Button node="button"><i className="material-icons">list</i></Button>}
      >
        <SideNavItem
          user={{
            background: 'https://placeimg.com/640/480/tech',
            email: 'test@gmail.com',
            image: 'https://media.suara.com/pictures/653x366/2020/04/22/25823-anya-geraldine.jpg',
